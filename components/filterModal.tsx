...
const PRICE_PRESETS = [
  { label: "Under ₦50k", min: null, max: 5000000 },
  { label: "₦50k – ₦1M", min: 5000000, max: 10000000 },
  { label: "₦1M – ₦2M", min: 10000000, max: 20000000 },
  { label: "Above ₦2M", min: 20000000, max: null },
];
...
export default function FilterModal({
  ...
  // styles shadow to avoid repetetion
  const shadow = {
    shadowColor: "#000",
